<template>
  ...
  <div class="drawer-head">
    <div class="drawer-brand-mark">棱镜</div>
  ...
  <div v-if="$store.getters.isLoggedIn" class="drawer-account-line">
    <span class="drawer-account-name">{{ displayUsername }}</span>

    <button class="drawer-inline-link" type="button" @click="goHome">
      首页
    </button>
...
.drawer-account {
  ...
  border-radius: 16px;
  background: #f8f3ec;
  border: 1px solid rgba(216, 208, 197, 0.55);
}
...
.drawer-account-btn--ghost {
  background: transparent;
  border: 1px solid rgba(180, 168, 154, 0.7);
}

.drawer-account-btn--ghost:hover {
  background: #f5efe7;
}
